...
RUN add-apt-repository -y ppa:ondrej/php && \
    DEBIAN_FRONTEND=noninteractive apt-get update && \
    apt-get install -y -qq php-pear php7.0-dev php7.0-mcrypt php7.0-zip php7.0-xml php7.0-mbstring php7.0-curl php7.0-json php7.0-mysql php7.0-sqlite3 php7.0-tokenizer php7.0-cli php7.0-imap php7.0-intl php7.0-xsl php7.0-bcmath php7.0-iconv php7.0-libsodium php7.0-xdebug && \
